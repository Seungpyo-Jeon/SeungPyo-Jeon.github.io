...
export const cvData: CVData = {
  ...
  summary: [
    ...
    "Hello, I'm **SeungPyo Jeon**, a **graduate student at Seoul National University of Science and Technology (SeoulTech)** and a member of [**MINT Lab**](https://mint-lab.github.io/), advised by [**Prof. Sunglok Choi**](https://mint-lab.github.io/sunglok/)",
